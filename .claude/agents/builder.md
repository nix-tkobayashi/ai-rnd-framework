...
- Scratch files (probes, old-code copies, smoke runs) go under `/tmp/<case-id>/`, not into the case logs. Only evidence the plan asks for goes under `experiments/EXP-NNN/logs/`.
